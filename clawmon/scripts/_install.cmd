...
echo.
echo.
echo *** Installation is started with the Enter key. Attention: The printer spooler is restarted. ***
echo.
echo.
...
copy "%~dp0clawmon.dll" "%WINDIR%\system32\clawmon.dll"
copy "%~dp0clawmonui.dll" "%WINDIR%\system32\clawmonui.dll"
net start spooler
"%~dp0regmon.exe" -r
PAUSE