...
namespace clawSoft.clawPDF.Shared.Assistants
{
    public class PrinterActionsAssistant
    {
        ...
        public bool DeletePrinter(string printerName, int numPrinters)
        {
            ...
            labels[0] = _translator.GetTranslation("MessageWindow", "Yes", "Yes");
            labels[1] = _translator.GetTranslation("MessageWindow", "No", "No");

            if (MessageWindow.Show(msg, cpt, labels, MessageWindowButtons.YesNo, MessageWindowIcon.Question) !=
