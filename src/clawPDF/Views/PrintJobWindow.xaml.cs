...
namespace clawSoft.clawPDF.Views
{
    internal partial class PrintJobWindow
    {
        ...
        private void profileChange(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                PasswordTab.Background = (Brush)Application.Current.FindResource(AdonisUI.Brushes.AccentHighlightBrush);
            }
            else
            {
                PasswordTab.Background = (Brush)Application.Current.FindResource(AdonisUI.Brushes.Layer1BackgroundBrush);
            }
