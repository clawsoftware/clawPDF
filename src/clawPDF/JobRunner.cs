    ...
    internal class JobRunner
    {
        ...
        private void ProcessJobs()
        {
            ...
            finally
            {
                ...
                if (JobInfoQueue.Instance.IsEmpty && !MainWindow.IsOpen) Environment.Exit(0);
        ...
        private void ShowManagePrintJobsWindow()
        {
            System.Windows.Application.Current.Dispatcher.Invoke(() =>
            {
                ...
                if (SettingsHelper.Settings.ApplicationSettings.PrinterDialogTopMost == true) revertTopMost = false;
