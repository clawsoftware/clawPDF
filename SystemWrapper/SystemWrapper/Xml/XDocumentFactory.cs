namespace SystemWrapper.Xml
{
    ...
    /// <summary>
    ///     The factory responsible for the creation of an instance of <see cref="IXDocument"/> class.
    /// </summary>
    public class XDocumentFactory : IXDocumentFactory
    {
        ...
        ///  </summary>
        public IXDocument Create()
        {
            return new XDocumentWrap();
        }
        ...
        /// </remarks>
        public IXDocument Create(params object[] content)
        {
            return new XDocumentWrap(content);
        }
        ...
        ///     See XContainer.Add(object content) for details about the content that can be added using this method.
        /// </remarks>
        public IXDocument Create(XDeclaration declaration,
                                 params object[] content)
        {
            return new XDocumentWrap(declaration, content);
        }
        ...
        public IXDocument Load(string uri,
                               LoadOptions options)
        {
            return new XDocumentWrap(uri, options);
        }
        ...
        /// <see cref="Stream"/>.
        /// </returns>
        public IXDocument Load(Stream stream)
        {
            return new XDocumentWrap(stream);
        }
        ...
        public IXDocument Load(Stream stream,
                               LoadOptions options)
        {
            return new XDocumentWrap(stream, options);
        }
        ...
        /// <see cref="TextReader"/>.
        /// </returns>
        public IXDocument Load(TextReader textReader)
        {
            return new XDocumentWrap(textReader);
        }
        ...
        public IXDocument Load(TextReader textReader,
                               LoadOptions options)
        {
            return new XDocumentWrap(textReader, options);
        }
        ...
        /// </returns>
        public IXDocument Load(XmlReader reader)
        {
            return new XDocumentWrap(reader);
        }
        ...
        public IXDocument Load(XmlReader reader,
                               LoadOptions options)
        {
            return new XDocumentWrap(reader, options);
        }
