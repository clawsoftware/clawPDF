namespace SystemWrapper.Web.Script.Serialization
{
    ...
    /// </summary>
    [GenerateFactory(typeof(IJavaScriptSerializerFactory))]
    public class JavaScriptSerializerWrap : IJavaScriptSerializer
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="JavaScriptSerializerWrap"/> class.
        /// </summary>
        public JavaScriptSerializerWrap()
        {
            this.Initialize();
        }
        ...
        public int MaxJsonLength
        {
            get
            {
                return this.JavaScriptSerializerInstance.MaxJsonLength;
            }

            set
            {
                this.JavaScriptSerializerInstance.MaxJsonLength = value;
            }
        }
        ...
        public int RecursionLimit
        {
            get
            {
                return this.JavaScriptSerializerInstance.RecursionLimit;
            }

            set
            {
                this.JavaScriptSerializerInstance.RecursionLimit = value;
            }
        }

        /// <summary>
        ///     Gets the java script serializer instance.
        /// </summary>
        public JavaScriptSerializer JavaScriptSerializerInstance { get; private set; }
        ...
        {
            return this.JavaScriptSerializerInstance.ConvertToType<T>(obj);
        }
        ...
        public object ConvertToType(object obj,
                                    Type targetType)
        {
            return this.JavaScriptSerializerInstance.ConvertToType(obj, targetType);
        }
        ...
        {
            return this.JavaScriptSerializerInstance.Deserialize<T>(input);
        }
        ...
        public object Deserialize(string input,
                                  Type targetType)
        {
            return this.JavaScriptSerializerInstance.Deserialize(input, targetType);
        }
        ...
        {
            return this.JavaScriptSerializerInstance.DeserializeObject(input);
        }
        ...
        {
            this.JavaScriptSerializerInstance.RegisterConverters(converters);
        }
        ...
        {
            return this.JavaScriptSerializerInstance.Serialize(obj);
        }
        ...
        {
            this.JavaScriptSerializerInstance.Serialize(obj, output);
        }

        private void Initialize()
        {
            this.JavaScriptSerializerInstance = new JavaScriptSerializer();
        }
